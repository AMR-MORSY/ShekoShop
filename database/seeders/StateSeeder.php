...
class StateSeeder extends Seeder
{
    ...
    public function run()
    {
        $Alexstates=["Al Hadrah Qebli","Amreya","Anfoushi","Asafra","Azarita","Bahary","Bakos","Baucalis","Bolkly","Camp Chezar","Cleopatra","Dekhela","Downtown", "Alexandria","El Atareen","El Gomrok","El Ibrahimiya",
