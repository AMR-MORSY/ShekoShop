        ...
        <aside id="logo-sidebar"
            ...
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
                <form action="{{route('products.search')}}" method="GET">
                    <div class=" flex border-2 rounded-lg overflow-hidden ">

                        <input type="text" name='search' value="{{request('search')}}"
                            class="border-0  w-full text-xs font-light focus:outline-none"
                            placeholder="SEARCH PRODUCTS......">
                        <button type="submit" class=" border-0 px-4 bg-slate-400 text-white font-bold">Search</button>
