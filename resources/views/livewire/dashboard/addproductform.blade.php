                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mt-2">
                            ...
                            <input type="file" class="form-control" id='facefront_image' wire:model='facefront_image'
                    ...
                    <div class="col-md-6">
                        <div class="form-group mt-2">
                            ...
                            <input type="text" id='ProductName'
                                ...
                                placeholder="Product Name" value="{{ old('product_name') }}" wire:model='product_name'
                                name='product_name'>
                        </div>
                        <div class="w-100 d-flex justify-content-start align-items-center mt-3">
                            @error('product_name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group mt-2">
                            ...
                            <input type="text" id='ProductPrice' class="form-control" placeholder="Product Price"
                                value="{{ old('product_price') }}" wire:model='product_price' name='product_price'>
                        </div>
                        <div class="w-100 d-flex justify-content-start align-items-center mt-3">
                            @error('product_price')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" min="0" id='ProductWeight' value="{{ old('product_weight') }}"
                                class="form-control" placeholder="Product Weight Kg..." wire:model='product_weight'
                                name='product_weight'>
                        </div>
                        <div class="w-100 d-flex justify-content-start align-items-center mt-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mt-2">
                            ...
                            <input maxlength="100" id='ProductThumb' class="form-control" placeholder="Product Thumb"
                                value="{{ old('product_thumb') }}" wire:model='product_thumb' name='product_thumb'>
                        </div>
                        <div class="w-100 d-flex justify-content-start align-items-center mt-3">
                            @error('product_thumb')
                                <span style="color: red; font-size:0.75rem; text-align:left;">{{ $message }}</span>
